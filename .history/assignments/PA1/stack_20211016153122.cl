...
class PlusCommand inherits StackCommand {
   eval(): StackCommand{
      let int1_base: StackCommand <- getNext(), int1_base: StackCommand <- int1_base.getNext(), intRes: IntCommand <- (new IntCommand) in{
         case int1:IntCommand of int1_base : IntCommand =>
            case int2:IntCommand of int1_base : IntCommand =>{
